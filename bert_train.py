...
def run_model(batch_size, learning_rate, n_ctx, n_head, n_embd, n_layer, adaptive, bpe, masked_lm, classification, bpe_model_path, datasets, lm_corpus_file, pos_tags, dict_path, rnn, crf, config_id):
    ...
    args.crf = crf
    args.cuda = True
    args.lang = args.datasets.split("_")[0]
...
def train_test(df_train, df_valid, df_test, args, stemmer, sp, folder=None):
    ...
    for epoch in range(args.num_epoch):
        ...
        while i < all_steps - cut:
            ...
            optimizer.zero_grad()
            #print(type(encoder_words),type(encoder_pos),type(batch_labels), type(mask))
                        ...
                        if idx == 1:
                            ...
                            for j in range(num_steps):
                                ...
                                if new_idx == 1:
                                    ...
                                    elif args.lang=='estonian' or args.lang == 'russian' or args.lang=='croatian' or args.lang=='slovenian':
...
if __name__ == '__main__':
    ...
    configs = [
        ...
        'POS_tags': False,
        'bpe': True,
        'bpe_model_path': 'bpe/SloBPE.model',
        'masked_lm': False,
        'rnn': False,
        'crf': False,
        'datasets': 'slovenian',
        'lm_corpus_file': '/data/slovenian/SlovenianBIG.json',
       # 'data_path' : ''
        },
    ]
